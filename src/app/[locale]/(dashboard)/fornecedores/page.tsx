...
const mockData = [
  ...
  },
  {
    ...
    nome: "Indústria MetalSul",
    area: "Manutenção Industrial",
    email: "info@metalsul.co.ao",
  ...
  },
  {
    ...
    area: "Limpeza & Jardinagem",
    email: "geral@jardimverde.ao",
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative ml-auto h-full w-full max-w-md ca-panel shadow-2xl flex flex-col">
            ...
            <form className="p-4 space-y-4 flex-1 overflow-y-auto ca-scroll">
              ...
              <input className="ca-input" placeholder="Área de atuação" />
