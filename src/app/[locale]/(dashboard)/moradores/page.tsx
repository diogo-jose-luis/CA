    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          ...
          <p className="text-sm ca-muted">
            Gestão de moradores registados no condomínio.
          </p>
        </div>
      ...
      <div className="ca-card p-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <input
            className="ca-input"
            placeholder="Pesquisar por residência"
          />
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 dark:bg-slate-800/40">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-medium">Residência</th>
          ...
          <tbody className="divide-y ca-border">
            {mockData.map((row, index) => (
              ...
              >
                ...
                <td className="px-4 py-3">{row.residencia}</td>
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative ml-auto h-full w-full max-w-md ca-panel shadow-2xl flex flex-col">
            ...
            <form className="p-4 space-y-4 flex-1 overflow-y-auto ca-scroll">
              ...
              <input
                className="ca-input"
                placeholder="Residência (ex: Moradia A-12)"
              />
              <input
                className="ca-input"
                placeholder="Setor"
